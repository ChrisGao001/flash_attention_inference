...
//
// Description: decoding int8ph

#pragma once

#include "common.h"

struct DecodingInt8PHParams {
    // The QKV matrices.
...
void run_quantization_int8ph_(const DecodingInt8PHParams &params);

template <size_t HeadDim>
void run_mha_decoding_int8ph_fwd_(const DecodingInt8PHParams &params);
